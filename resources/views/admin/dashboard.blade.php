...
<div class="dash-scope">
    <div class="dash-wrap">
        ...
        <div class="dash-quick-links">
            <a href="{{ route('products.index') }}" class="dash-link-btn">Manage Products</a>
            <a href="{{ route('categories.index') }}" class="dash-link-btn">Manage Categories</a>
        ...
        <div class="dash-table-card">
            ...
            @else
                <div class="dash-empty">No orders have been placed yet.</div>
            @endif
        </div>
